...
<body>
<div class="container">
<div style="background: url('images/gym.jpg') no-repeat center center/cover; min-height: 100vh; padding: 50px;">
  <div style="max-width: 600px; margin: auto; background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.3);">
